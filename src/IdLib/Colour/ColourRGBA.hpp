...
/// @file IdLib/Colour/ColourRGBA.hpp
...
#include "IdLib/Colour/ColourRGB.hpp"
#include "IdLib/CRTP.hpp"

namespace Id {

/// @brief A colour value in RGBA colour space.
...
public:
    ...
    /// @brief Construct this colour from the specified color of the corresponding opaque colour space and the specified alpha component value.
    /// @param rgb the red, green and blue components of the colour as a colour in RGB colour space
    ...
    /// @brief Construct this colour from the component values of a specified other colour.
